/**
 * Local simulation harness for Free Review lead-session applicator.
...
const {
  ...
  ATTESTED_FREEZE_ENV,
} = require("../../../scripts/security/free-review-lead-session-apply-constants.js");
...
async function startDisposablePg() {
  const name = `frls-apply-sim-${crypto.randomBytes(3).toString("hex")}`;
