...
const summary: ActiveReportSummary = {
  ...
  netProfitMarginEvidenceReady: true,
  operatingGrossMarginEvidenceReady: true,
  netProfitMarginReady: true,
  operatingGrossMarginReady: true,
  netIncomeEvidencePath: "explicit_totals",
