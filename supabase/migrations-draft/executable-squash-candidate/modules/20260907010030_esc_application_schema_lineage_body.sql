...
-- Proposed name: esc_application_schema_lineage_body
-- Module: public_application_schema_baseline_body
-- Provenance: Option D assembled body (124 files) excluding d6/tcp1/grant disposition targets
...
-- >>> begin 20260906184500_publish_ledger_event_extensions_digest_qualify.sql
