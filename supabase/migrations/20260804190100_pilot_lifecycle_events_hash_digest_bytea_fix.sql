-- Phase MEM-LIFECYCLE Block 2 follow-up — digest search_path + bytea cast
-- Supabase installs pgcrypto in schema "extensions". SECURITY DEFINER
-- functions must include extensions in search_path (and cast alg to text).
