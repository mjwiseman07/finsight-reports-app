...
// Resolution path (D1.1): firm_client -> owner_user_id -> accounting_connections
// only (no erp_connections / quickbooks_connections fallback).
// Returns { qbo, accessToken, realmId, userId, tokenSource } for a
