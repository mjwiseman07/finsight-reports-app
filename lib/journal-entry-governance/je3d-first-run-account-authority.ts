...
/**
 * Locked after independent Demo A COA mirror verification:
 *   15 = Office Expenses (Expense, active)
 *   1150040002 = Accrued Expenses - Advisacor Test (Other Current Liability, active)
 * Execution/dispatch still requires separate FIRST_RUN_EXECUTION_REVIEWED_AND_APPROVED.
 */
...
export const FIRST_RUN_ACCOUNT_APPROVAL_RECOMMENDATION =
  "ACCOUNTS REVIEWED AND APPROVED — EXECUTION DISPATCH STILL REQUIRES SEPARATE APPROVAL" as const;
