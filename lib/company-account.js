...
export const manualFinancialUploadReports = [
  ...
  { id: "payroll_reports", label: "Payroll Reports", required: false },
  { id: "fixed_asset_reports", label: "Fixed Asset Reports", required: false },
  { id: "budget_reports", label: "Budget Reports", required: false },
];
