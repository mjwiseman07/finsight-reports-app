...
export const automatedDeliveryOutputTypes = [
  {
    ...
    description:
      "Brief, owner-friendly, email-ready dashboard summary for revenue trend, cash position, AR collections, payroll trend, top risk, top opportunity, and short AI summary.",
    includes: [
      "Revenue trend",
      "Cash position",
      "AR collections",
...
export const ownerEmailTemplateSpec = {
  weeklySubject: "Your Advisacor Executive Brief is Ready",
  monthlySubject: "Your Advisacor Monthly Executive Package is Ready",
  header: "Advisacor Executive Brief",
  intro: "Here is your weekly business snapshot.",
  primaryCta: "Ask Advisacor About This Report",
