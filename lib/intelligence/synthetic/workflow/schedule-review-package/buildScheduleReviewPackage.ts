...
export type SyntheticScheduleReviewPackageCategory =
  | "schedule_review_package"
  | "schedule_completeness_review_package"
  | "schedule_tie_out_review_package"
  | "schedule_evidence_review_package"
  | "schedule_pbc_review_package"
  | "schedule_readiness_review_package"
  | "schedule_support_context_package";

export const SYNTHETIC_SCHEDULE_REVIEW_PACKAGE_CATEGORIES: SyntheticScheduleReviewPackageCategory[] = [
  "schedule_review_package",
  "schedule_completeness_review_package",
  "schedule_tie_out_review_package",
  "schedule_evidence_review_package",
...
export interface SyntheticScheduleReviewPackageIsolationDimension {
  required: boolean;
  referenceIds: string[];
}

export interface SyntheticScheduleReviewForwardCompatibleObservation {
...
export interface BuildScheduleReviewPackageInput {
  auditContract: SyntheticAuditContract | null;
  packageKey: string;
  packageCategory: SyntheticScheduleReviewPackageCategory;
  ...
  healthcarePpdObservations?: SyntheticScheduleReviewForwardCompatibleObservation[];
  payrollObservations?: SyntheticScheduleReviewForwardCompatibleObservation[];
  methodologyObservations?: SyntheticScheduleReviewForwardCompatibleObservation[];
...
export interface SyntheticScheduleReviewPackage {
  packageId: string;
  packageKey: string;
  packageCategory: SyntheticScheduleReviewPackageCategory;
  companyId: string;
  ...
  customerIsolation: SyntheticScheduleReviewPackageIsolationDimension;
  firmIsolation: SyntheticScheduleReviewPackageIsolationDimension;
  clientIsolation: SyntheticScheduleReviewPackageIsolationDimension;
  evidenceReferenceIds: string[];
  sourceReferenceIds: string[];
  lineageReferenceIds: string[];
  auditContractReferenceIds: string[];
...
export interface BuildScheduleReviewPackageResult {
  scheduleReviewPackage: SyntheticScheduleReviewPackage | null;
  skipped: boolean;
  warnings: string[];
}
...
function isSupportedPackageCategory(category: SyntheticScheduleReviewPackageCategory): boolean {
  return SYNTHETIC_SCHEDULE_REVIEW_PACKAGE_CATEGORIES.includes(category);
}

function buildCustomerIsolation(scope: SyntheticAuditScope): SyntheticScheduleReviewPackageIsolationDimension {
  return { required: scope.customerIsolationRequired, referenceIds: uniqueStable([scope.companyId, ...scope.isolationBoundaryIds]) };
}

function buildFirmIsolation(scope: SyntheticAuditScope): SyntheticScheduleReviewPackageIsolationDimension {
  return {
...
function buildClientIsolation(scope: SyntheticAuditScope): SyntheticScheduleReviewPackageIsolationDimension {
  return {
...
function getDomainObservations(input: BuildScheduleReviewPackageInput): object[] {
  return [
...
function getAuditArtifacts(input: BuildScheduleReviewPackageInput): AuditArtifact[] {
  return [
...
function getPackagedAuditArtifacts(
  input: BuildScheduleReviewPackageInput,
): Array<
  | SyntheticAuditEvidencePackage
  | SyntheticAuditFinding
  | SyntheticAuditConfidence
...
function getUpstreamPackages(input: BuildScheduleReviewPackageInput): UpstreamPackage[] {
  return [
...
function getAuditContractReferenceIds(input: BuildScheduleReviewPackageInput): string[] {
...
function getReferenceIds(input: BuildScheduleReviewPackageInput, singularName: string, arrayName: string): string[] {
  return uniqueStable([
...
function getEvidenceReferenceIds(input: BuildScheduleReviewPackageInput): string[] {
  return uniqueStable([
...
function getSourceReferenceIds(input: BuildScheduleReviewPackageInput): string[] {
  return uniqueStable([
...
function getLineageReferenceIds(input: BuildScheduleReviewPackageInput): string[] {
  return uniqueStable([
...
function getScheduleReviewObservationIds(input: BuildScheduleReviewPackageInput) {
  return {
...
function getUpstreamObservationIds(input: BuildScheduleReviewPackageInput): string[] {
  const observationIds = getScheduleReviewObservationIds(input);
  return uniqueStable([
...
function getMaterialityMetadata(input: BuildScheduleReviewPackageInput): SyntheticAuditMaterialityCompatibility[] {
...
function buildPackageId(input: BuildScheduleReviewPackageInput): string {
  return `synthetic-schedule-review-package:${stableSnapshotHash({
    ...
    ...getScheduleReviewObservationIds(input),
...
function getForwardCompatibilityWarnings(input: BuildScheduleReviewPackageInput): string[] {
  return [
...
function validateInput(input: BuildScheduleReviewPackageInput): string[] {
...
export function buildScheduleReviewPackage(input: BuildScheduleReviewPackageInput): BuildScheduleReviewPackageResult {
  const fatalWarnings = validateInput(input);
  if (fatalWarnings.length > 0 || !input.auditContract) {
    return {
      scheduleReviewPackage: null,
      skipped: true,
