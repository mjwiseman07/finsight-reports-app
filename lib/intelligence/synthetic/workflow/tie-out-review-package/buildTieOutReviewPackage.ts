...
export type SyntheticTieOutReviewPackageCategory =
  | "tie_out_review_package"
  | "tie_out_schedule_review_package"
  | "tie_out_reconciliation_review_package"
  | "tie_out_evidence_review_package"
  | "tie_out_coverage_review_package"
  | "tie_out_trust_review_package"
  | "tie_out_package_lineage_review";

export const SYNTHETIC_TIE_OUT_REVIEW_PACKAGE_CATEGORIES: SyntheticTieOutReviewPackageCategory[] = [
  "tie_out_review_package",
  "tie_out_schedule_review_package",
  "tie_out_reconciliation_review_package",
  "tie_out_evidence_review_package",
...
export interface SyntheticTieOutReviewPackageIsolationDimension {
  required: boolean;
  referenceIds: string[];
}

export interface SyntheticTieOutReviewForwardCompatibleObservation {
...
export interface BuildTieOutReviewPackageInput {
  auditContract: SyntheticAuditContract | null;
  packageKey: string;
  packageCategory: SyntheticTieOutReviewPackageCategory;
  ...
  healthcarePpdObservations?: SyntheticTieOutReviewForwardCompatibleObservation[];
  payrollObservations?: SyntheticTieOutReviewForwardCompatibleObservation[];
  methodologyObservations?: SyntheticTieOutReviewForwardCompatibleObservation[];
...
export interface SyntheticTieOutReviewPackage {
  packageId: string;
  packageKey: string;
  packageCategory: SyntheticTieOutReviewPackageCategory;
  companyId: string;
  ...
  customerIsolation: SyntheticTieOutReviewPackageIsolationDimension;
  firmIsolation: SyntheticTieOutReviewPackageIsolationDimension;
  clientIsolation: SyntheticTieOutReviewPackageIsolationDimension;
  evidenceReferenceIds: string[];
  sourceReferenceIds: string[];
  lineageReferenceIds: string[];
  auditContractReferenceIds: string[];
...
export interface BuildTieOutReviewPackageResult {
  tieOutReviewPackage: SyntheticTieOutReviewPackage | null;
  skipped: boolean;
  warnings: string[];
}
...
function isSupportedPackageCategory(category: SyntheticTieOutReviewPackageCategory): boolean {
  return SYNTHETIC_TIE_OUT_REVIEW_PACKAGE_CATEGORIES.includes(category);
}

function buildCustomerIsolation(scope: SyntheticAuditScope): SyntheticTieOutReviewPackageIsolationDimension {
  return { required: scope.customerIsolationRequired, referenceIds: uniqueStable([scope.companyId, ...scope.isolationBoundaryIds]) };
}

function buildFirmIsolation(scope: SyntheticAuditScope): SyntheticTieOutReviewPackageIsolationDimension {
  return {
...
function buildClientIsolation(scope: SyntheticAuditScope): SyntheticTieOutReviewPackageIsolationDimension {
  return {
...
function getDomainObservations(input: BuildTieOutReviewPackageInput): object[] {
  return [
...
function getAuditArtifacts(input: BuildTieOutReviewPackageInput): AuditArtifact[] {
  return [
...
function getPackagedAuditArtifacts(
  input: BuildTieOutReviewPackageInput,
): Array<
  | SyntheticAuditEvidencePackage
  | SyntheticAuditFinding
  | SyntheticAuditConfidence
...
function getUpstreamPackages(input: BuildTieOutReviewPackageInput): UpstreamPackage[] {
  return [
...
function getAuditContractReferenceIds(input: BuildTieOutReviewPackageInput): string[] {
...
function getReferenceIds(input: BuildTieOutReviewPackageInput, singularName: string, arrayName: string): string[] {
  return uniqueStable([
...
function getEvidenceReferenceIds(input: BuildTieOutReviewPackageInput): string[] {
  return uniqueStable([
...
function getSourceReferenceIds(input: BuildTieOutReviewPackageInput): string[] {
  return uniqueStable([
...
function getLineageReferenceIds(input: BuildTieOutReviewPackageInput): string[] {
  return uniqueStable([
...
function getTieOutReviewObservationIds(input: BuildTieOutReviewPackageInput) {
  return {
...
function getUpstreamObservationIds(input: BuildTieOutReviewPackageInput): string[] {
  const observationIds = getTieOutReviewObservationIds(input);
  return uniqueStable([
...
function getMaterialityMetadata(input: BuildTieOutReviewPackageInput): SyntheticAuditMaterialityCompatibility[] {
...
function buildPackageId(input: BuildTieOutReviewPackageInput): string {
  return `synthetic-tie-out-review-package:${stableSnapshotHash({
    ...
    ...getTieOutReviewObservationIds(input),
...
function getForwardCompatibilityWarnings(input: BuildTieOutReviewPackageInput): string[] {
  return [
...
function validateInput(input: BuildTieOutReviewPackageInput): string[] {
...
export function buildTieOutReviewPackage(input: BuildTieOutReviewPackageInput): BuildTieOutReviewPackageResult {
  const fatalWarnings = validateInput(input);
  if (fatalWarnings.length > 0 || !input.auditContract) {
    return {
      tieOutReviewPackage: null,
      skipped: true,
