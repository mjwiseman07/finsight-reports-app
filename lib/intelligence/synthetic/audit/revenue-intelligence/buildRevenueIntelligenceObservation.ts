...
export type SyntheticRevenueIntelligenceCategory =
  | "revenue_recognition"
  | "deferred_revenue"
  ...
  | "revenue_timing"
  | "revenue_relationship_candidate"
  | "revenue_balance_change"
  | "revenue_reconciliation_risk"
  | "deferred_revenue_relationship"
  | "asc606_candidate"
  | "revenue_financial_statement_relationship";

export const SYNTHETIC_REVENUE_INTELLIGENCE_CATEGORIES: SyntheticRevenueIntelligenceCategory[] = [
  "revenue_recognition",
  "deferred_revenue",
  "performance_obligation",
  "contract_modification",
...
export interface BuildRevenueIntelligenceObservationInput {
  auditContract: SyntheticAuditContract | null;
  revenueIntelligenceObservationKey: string;
  revenueIntelligenceCategory: SyntheticRevenueIntelligenceCategory;
...
export interface SyntheticRevenueIntelligenceObservation {
  revenueIntelligenceObservationId: string;
  revenueIntelligenceObservationKey: string;
  revenueIntelligenceCategory: SyntheticRevenueIntelligenceCategory;
  companyId: string;
...
export interface BuildRevenueIntelligenceObservationResult {
  revenueIntelligenceObservation: SyntheticRevenueIntelligenceObservation | null;
  skipped: boolean;
  warnings: string[];
}
...
function isSupportedRevenueIntelligenceCategory(category: SyntheticRevenueIntelligenceCategory): boolean {
  return SYNTHETIC_REVENUE_INTELLIGENCE_CATEGORIES.includes(category);
}
...
function getAuditCandidates(input: BuildRevenueIntelligenceObservationInput): SyntheticAuditCandidate[] {
  return input.auditCandidates ?? [];
}

function getAuditEvidencePackages(input: BuildRevenueIntelligenceObservationInput): SyntheticAuditEvidencePackage[] {
  return input.auditEvidencePackages ?? [];
}

function getAuditFindings(input: BuildRevenueIntelligenceObservationInput): SyntheticAuditFinding[] {
  return input.auditFindings ?? [];
}

function getAuditConfidencePackages(input: BuildRevenueIntelligenceObservationInput): SyntheticAuditConfidence[] {
  return input.auditConfidencePackages ?? [];
}

function getAuditSurfaces(input: BuildRevenueIntelligenceObservationInput): SyntheticAuditSurface[] {
  return input.auditSurfaces ?? [];
}

function getAuditWatchlists(input: BuildRevenueIntelligenceObservationInput): SyntheticAuditWatchlist[] {
  return input.auditWatchlists ?? [];
}

function getAuditBriefings(input: BuildRevenueIntelligenceObservationInput): SyntheticAuditBriefing[] {
  return input.auditBriefings ?? [];
}

function getAllAuditArtifacts(input: BuildRevenueIntelligenceObservationInput): AuditArtifact[] {
  return [
...
function getPackagedAuditArtifacts(
  input: BuildRevenueIntelligenceObservationInput,
): Array<
  | SyntheticAuditEvidencePackage
  | SyntheticAuditFinding
  | SyntheticAuditConfidence
...
function getEvidenceReferenceIds(input: BuildRevenueIntelligenceObservationInput): string[] {
  return uniqueStable([
...
function getSourceReferenceIds(input: BuildRevenueIntelligenceObservationInput): string[] {
  return uniqueStable([
...
function getLineageReferenceIds(input: BuildRevenueIntelligenceObservationInput): string[] {
  return uniqueStable([
...
function getRevenueReferenceIds(input: BuildRevenueIntelligenceObservationInput): string[] {
  return uniqueStable([
...
function buildRevenueIntelligenceObservationId(input: BuildRevenueIntelligenceObservationInput): string {
  return `synthetic-revenue-intelligence-observation:${stableSnapshotHash({
    revenueIntelligenceObservationKey: input.revenueIntelligenceObservationKey,
    revenueIntelligenceCategory: input.revenueIntelligenceCategory,
    ...
    revenueReferenceIds: getRevenueReferenceIds(input),
...
function validateArtifacts(input: BuildRevenueIntelligenceObservationInput, warnings: string[]): void {
...
function validateInput(input: BuildRevenueIntelligenceObservationInput): string[] {
  ...
  if (!hasValue(input.revenueIntelligenceObservationKey)) warnings.push("revenueIntelligenceObservationKey is required.");
  if (!hasValue(input.revenueIntelligenceCategory)) warnings.push("revenueIntelligenceCategory is required.");
  if (!isSupportedRevenueIntelligenceCategory(input.revenueIntelligenceCategory)) {
    warnings.push("revenueIntelligenceCategory must be a supported revenue intelligence category.");
  }
...
export function buildRevenueIntelligenceObservation(
  input: BuildRevenueIntelligenceObservationInput,
): BuildRevenueIntelligenceObservationResult {
  const warnings = validateInput(input);
  if (warnings.length > 0 || !input.auditContract) {
    return {
      revenueIntelligenceObservation: null,
      skipped: true,
      warnings,
    };
  }
  ...
  return {
    revenueIntelligenceObservation: {
      revenueIntelligenceObservationId: buildRevenueIntelligenceObservationId(input),
      revenueIntelligenceObservationKey: input.revenueIntelligenceObservationKey,
      revenueIntelligenceCategory: input.revenueIntelligenceCategory,
