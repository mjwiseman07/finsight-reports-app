...
export type SyntheticAuditScheduleCategory =
  | "inventory_rollforward_schedule"
  | "fixed_asset_rollforward_schedule"
  | "debt_schedule"
  | "lease_schedule"
  | "revenue_schedule"
  ...
  | "tax_schedule"
  | "supporting_schedule"
  | "audit_schedule_candidate";

export const SYNTHETIC_AUDIT_SCHEDULE_CATEGORIES: SyntheticAuditScheduleCategory[] = [
  "inventory_rollforward_schedule",
  "fixed_asset_rollforward_schedule",
  "debt_schedule",
  "lease_schedule",
...
export interface BuildAuditScheduleObservationInput {
  auditContract: SyntheticAuditContract | null;
  auditScheduleObservationKey: string;
  auditScheduleCategory: SyntheticAuditScheduleCategory;
...
export interface SyntheticAuditScheduleObservation {
  auditScheduleObservationId: string;
  auditScheduleObservationKey: string;
  auditScheduleCategory: SyntheticAuditScheduleCategory;
  companyId: string;
...
export interface BuildAuditScheduleObservationResult {
  auditScheduleObservation: SyntheticAuditScheduleObservation | null;
  skipped: boolean;
  warnings: string[];
}
...
function isSupportedAuditScheduleCategory(category: SyntheticAuditScheduleCategory): boolean {
  return SYNTHETIC_AUDIT_SCHEDULE_CATEGORIES.includes(category);
}
...
function getAuditCoverageObservations(input: BuildAuditScheduleObservationInput): SyntheticAuditCoverageObservation[] {
  return input.auditCoverageObservations ?? [];
}

function getEvidenceSufficiencyObservations(
  input: BuildAuditScheduleObservationInput,
): SyntheticEvidenceSufficiencyObservation[] {
  return input.evidenceSufficiencyObservations ?? [];
}

function getPbcRequestObservations(input: BuildAuditScheduleObservationInput): SyntheticPbcRequestObservation[] {
  return input.pbcRequestObservations ?? [];
}

function getContinuousAuditObservations(input: BuildAuditScheduleObservationInput): SyntheticContinuousAuditObservation[] {
...
function getDomainObservations(input: BuildAuditScheduleObservationInput): DomainObservation[] {
  return [
...
function getAuditCandidates(input: BuildAuditScheduleObservationInput): SyntheticAuditCandidate[] {
  return input.auditCandidates ?? [];
}

function getAuditEvidencePackages(input: BuildAuditScheduleObservationInput): SyntheticAuditEvidencePackage[] {
  return input.auditEvidencePackages ?? [];
}

function getAuditFindings(input: BuildAuditScheduleObservationInput): SyntheticAuditFinding[] {
  return input.auditFindings ?? [];
}

function getAuditConfidencePackages(input: BuildAuditScheduleObservationInput): SyntheticAuditConfidence[] {
  return input.auditConfidencePackages ?? [];
}

function getAuditSurfaces(input: BuildAuditScheduleObservationInput): SyntheticAuditSurface[] {
  return input.auditSurfaces ?? [];
}

function getAuditWatchlists(input: BuildAuditScheduleObservationInput): SyntheticAuditWatchlist[] {
  return input.auditWatchlists ?? [];
}

function getAuditBriefings(input: BuildAuditScheduleObservationInput): SyntheticAuditBriefing[] {
  return input.auditBriefings ?? [];
}

function getAllAuditArtifacts(input: BuildAuditScheduleObservationInput): AuditArtifact[] {
  return [
...
function getEvidenceReferenceIds(input: BuildAuditScheduleObservationInput): string[] {
  return uniqueStable([
...
function getSourceReferenceIds(input: BuildAuditScheduleObservationInput): string[] {
  return uniqueStable([
...
function getLineageReferenceIds(input: BuildAuditScheduleObservationInput): string[] {
  return uniqueStable([
...
function getAuditContractReferenceIdsFromInput(input: BuildAuditScheduleObservationInput): string[] {
  return uniqueStable([
...
function getAuditCandidateIds(input: BuildAuditScheduleObservationInput): string[] {
  return uniqueStable([
...
function getAuditEvidencePackageIds(input: BuildAuditScheduleObservationInput): string[] {
  return uniqueStable([
    ...getAllAuditArtifacts(input).flatMap((artifact) => [
...
function getAuditFindingArtifactIds(input: BuildAuditScheduleObservationInput): string[] {
  return uniqueStable([
    ...getAllAuditArtifacts(input).flatMap((artifact) => [
...
function getAuditFindingIds(input: BuildAuditScheduleObservationInput): string[] {
  return uniqueStable([
    ...getAllAuditArtifacts(input).flatMap((artifact) => [
...
function getAuditConfidenceIds(input: BuildAuditScheduleObservationInput): string[] {
  return uniqueStable([
    ...getAllAuditArtifacts(input).flatMap((artifact) => [
...
function getAuditSurfaceIds(input: BuildAuditScheduleObservationInput): string[] {
  return uniqueStable([
    ...getAllAuditArtifacts(input).flatMap((artifact) => [
...
function getAuditWatchlistIds(input: BuildAuditScheduleObservationInput): string[] {
  return uniqueStable([
    ...getAllAuditArtifacts(input).flatMap((artifact) => [
...
function getAuditBriefingIds(input: BuildAuditScheduleObservationInput): string[] {
  return uniqueStable([
    ...getAllAuditArtifacts(input).flatMap((artifact) => [
...
function getAuditScheduleReferenceIds(input: BuildAuditScheduleObservationInput): string[] {
  return uniqueStable([
...
function buildAuditScheduleObservationId(input: BuildAuditScheduleObservationInput): string {
  return `synthetic-audit-schedule-observation:${stableSnapshotHash({
    auditScheduleObservationKey: input.auditScheduleObservationKey,
    auditScheduleCategory: input.auditScheduleCategory,
    ...
    auditScheduleReferenceIds: getAuditScheduleReferenceIds(input),
...
function validateAuditArtifacts(input: BuildAuditScheduleObservationInput, warnings: string[]): void {
...
function validateDomainObservationIds(input: BuildAuditScheduleObservationInput, warnings: string[]): void {
  const companyId = input.auditContract?.scope.companyId;
...
function validateInput(input: BuildAuditScheduleObservationInput): string[] {
  ...
  if (!hasValue(input.auditScheduleObservationKey)) warnings.push("auditScheduleObservationKey is required.");
  if (!hasValue(input.auditScheduleCategory)) warnings.push("auditScheduleCategory is required.");
  if (!isSupportedAuditScheduleCategory(input.auditScheduleCategory)) {
    warnings.push("auditScheduleCategory must be a supported audit schedule category.");
  }
...
export function buildAuditScheduleObservation(
  input: BuildAuditScheduleObservationInput,
): BuildAuditScheduleObservationResult {
  const warnings = validateInput(input);
  if (warnings.length > 0 || !input.auditContract) {
    return {
      auditScheduleObservation: null,
      skipped: true,
      warnings,
    };
  }
  ...
  return {
    auditScheduleObservation: {
      auditScheduleObservationId: buildAuditScheduleObservationId(input),
      auditScheduleObservationKey: input.auditScheduleObservationKey,
      auditScheduleCategory: input.auditScheduleCategory,
