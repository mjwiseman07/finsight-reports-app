...
export function evaluateContingentFee(ctx: { containsProfessionalEngagementData?: boolean }, input: { probable: boolean; constrained: boolean; engagementLevel: boolean }) {
  assertContainsProfessionalEngagementData(ctx);
