...
export function assertSoc2CommonCriteria(
  ...
  if (!input.attested) {
    ...
    throw Object.assign(new Error("SAAS_SOC2_TSC_VIOLATION"), {
      escalationAudits: [{ channel: "escalation-audit", code: "SAAS_SOC2_TSC_VIOLATION", message: "common-criteria.ts" }],
    });
  }
  emitter.emitArrMrr("soc2-tsc-cc-asserted", input);
