...
export function evaluateMeasureOfProgress(
  ctx: { containsSaaSARRData?: boolean },
  input: Record<string, unknown>,
  emitter: SaasAuditEmitter = createSaasAuditEmitter(),
) {
  assertContainsSaaSARRData(ctx);
  emitter.emitArrMrr("usage-classified-measure-of-progress", { module: "usage-based-variable-consideration-measure-of-progress", input });
  return { ok: true };
}
