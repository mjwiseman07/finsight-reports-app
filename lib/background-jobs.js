...
export function assertBackgroundJobPreflight({ reportDataContext, preflightResult, jobType }) {
  if (!reportDataContext || !preflightResult?.passed) {
    ...
    error.status = 422;
    error.preflight = preflightResult || null;
