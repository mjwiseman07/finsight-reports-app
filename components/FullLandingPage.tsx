  ...
  return (
    <main className="min-h-screen bg-[#F5F7FA] text-[#111827]">
      ...
      >
        ...
        <div className="relative z-10 mx-auto grid max-w-7xl items-center gap-12 pt-[200px] sm:pt-[220px] md:pt-[240px] lg:grid-cols-[minmax(0,0.95fr)_minmax(380px,1.05fr)] lg:pt-[260px] xl:pt-[280px]">
