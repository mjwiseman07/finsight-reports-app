...
export default function PersonaTile({
  ...
  return (
    <Link
      href={href}
      className={`group flex flex-col justify-between rounded-2xl border border-white/10 bg-[#111112] p-6 transition-all hover:border-[#C9A961]/60 hover:bg-[#141416] ${focusRing()}`}
    >
      <div>
