...
const modules = [
  ...
  {
    phase: "36P",
    module: "memory-preservation-package",
    singularName: "MemoryPreservationPackage",
    pluralName: "MemoryPreservationPackages",
    artifact: "SyntheticMemoryPreservationPackage",
    idToken: "memoryPreservationPackageId",
    keyToken: "memoryPreservationPackageKey",
    nullToken: "memoryPreservationPackage: null",
    resultToken: "memoryPreservationPackage",
    collectionResultToken: "memoryPreservationPackages",
    collectionInputToken: "preservationInputs",
    extraMarkers: [
      "packageCategory",
      ...
      "acquisitionReferenceIds",
      "entityChangeReferenceIds",
      "firmClientTransitionReferenceIds",
      ...
      "continuityMetadata",
      "preservationGovernanceMetadata",
    ],
  },
];
...
const prohibitedPatterns = [
  ...
  [/\bgovernance execution\b|\bgovernanceExecution\b|\bexecuteGovernance\b/i, "no governance execution"],
...
assert(implementedModules.includes("memory-preservation-package"), "memory preservation package is implemented and verified in Wave 4");
