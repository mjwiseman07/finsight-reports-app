#!/usr/bin/env node
/**
 * Deterministic standalone bundle builder for RA Pro accounting-automation
 * CORRECTIVE applicator. Same pattern as the dual-package assemble script.
 */
"use strict";
...
const ENTRY = path.join(ROOT, "scripts/security/apply-ra-pro-accounting-automation-corrective.js");
const OUT_REL =
