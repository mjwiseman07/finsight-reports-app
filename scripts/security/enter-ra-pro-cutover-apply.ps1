...
<#
.SYNOPSIS
  Native entry trust-root helper for RA Pro billing-company cutover apply (pre-Node).
...
.DESCRIPTION
  ...
  RA_PRO_CUTOVER_APPLY_DATABASE_URL values.
#>
[CmdletBinding()]
param(
...
function Write-EntryEvidence {
  param($Object)
  # Emit exactly one RA_PRO_CUTOVER_EVIDENCE_V1 frame. Do not probe missing
