...
.DESCRIPTION
  Invoked only after tip→freeze seal verification by enter-visible-free-review-lead-session-ceremony.ps1.
  ...
  Never reads FREE_REVIEW_LEAD_SESSION_APPLY_DATABASE_URL. Never uses cmd.exe or PATH powershell.exe.
#>
[CmdletBinding()]
param(
