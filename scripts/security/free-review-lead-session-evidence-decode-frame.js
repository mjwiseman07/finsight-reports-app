#!/usr/bin/env node
/**
 * Decode an FRLS_LEAD_SESSION_EVIDENCE_V1 frame from a captured stdout file.
 *
 * Usage:
 *   node free-review-lead-session-evidence-decode-frame.js <evidence.js> <stdout.txt>
 *
 * argv[2] = path to free-review-lead-session-evidence.js
...
function main() {
  ...
  if (!protocolPath || !stdoutPath) {
    process.stderr.write(
      "usage: node free-review-lead-session-evidence-decode-frame.js <evidence.js> <stdout.txt>\n",
    );
    process.exitCode = 2;
    return;
  }
