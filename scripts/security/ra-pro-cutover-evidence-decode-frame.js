#!/usr/bin/env node
/**
 * Decode an RA_PRO_CUTOVER_EVIDENCE_V1 frame from a captured stdout file.
 *
 * Usage:
 *   node ra-pro-cutover-evidence-decode-frame.js <evidence.js> <stdout.txt>
 *
 * argv[2] = path to ra-pro-cutover-evidence.js
...
function main() {
  ...
  if (!protocolPath || !stdoutPath) {
    process.stderr.write(
      "usage: node ra-pro-cutover-evidence-decode-frame.js <evidence.js> <stdout.txt>\n",
    );
    process.exitCode = 2;
    return;
  }
