...
function main() {
  ...
  const code = parsed
    ...
    : out;
  if (
    !/BUNDLE_|AUTHORIZATION_PINS_UNPUBLISHED|APPLY_REMAINS_BLOCKED_BEFORE_CREDENTIALS|PRECONDITION_EVIDENCE_EXPIRED|PRE_APPLY_LIVE_EXPIRED|BLOCKED_PIN_MISMATCH|GIT_BLOB|MISSING_INPUT|DATABASE_PROJECT_REF_MISMATCH|BLOCKED_TLS_/i.test(
      code,
    )
  ) {
