...
var require_ra_pro_cutover_apply_constants = __commonJS({
  "scripts/security/ra-pro-cutover-apply-constants.js"(exports2, module2) {
    "use strict";
    var ADVISORY_LOCK2 = Object.freeze({
    ...
    var EXPECTED_PROJECT_REF2 = "jzmdgwwiestcmmeuhhkr";
    var ARTIFACT_COMMIT2 = "b4f06a1ca889bdfb477397b990860b21e788a877";
    var MIGRATION_PATH2 = "supabase/migrations/20260915004500_ra_pro_firm_billing_company_id.sql";
    var MIGRATION_BLOB_OID2 = "d36f5e2c50f7bab956c3191723c0e8a223279df5";
    var MIGRATION_SHA2562 = "c756651f267aaa2ebe5f1331e96d62bfa882507917b4201397f77e25a45f5ff9";
    var MIGRATION_BYTES2 = 40289;
    var MIGRATION_VERSION2 = "20260915004500";
    var MIGRATION_NAME2 = "ra_pro_firm_billing_company_id";
    var PRIOR_HISTORY_COUNT = 187;
    var DECISION_PATH = "docs/security/ra-pro-cutover-operator-decision.json";
    var DECISION_BLOB_OID = "0dd39de5ffbfd2b35d3d73887dd0fa915a061c93";
    var DECISION_SHA256 = "f00039cb536b0ffef09ea41c0613ce83d7f52067b2bffc4ff27980f8e9bd46e1";
    var DECISION_BYTES = 1122;
    var MAPPING_SHA256 = "93f6fe31360222ccd282e814a3764ccf07929e7cb91c25c70e10b750ec0ec953";
    var EXPECTED_DECISION_ACTIONS = Object.freeze({
      NO_CUTOVER: 4,
      LINK_EXISTING_FIRM: 0,
      CREATE_NEW_FIRM: 0
    });
    var EXPECTED_LINKED_FIRMS_AFTER_MIGRATION = 0;
    var DATABASE_URL_ENV2 = "RA_PRO_CUTOVER_APPLY_DATABASE_URL";
    var FORBIDDEN_SSL_ROOTCERT_ENV = "RA_PRO_CUTOVER_APPLY_SSL_ROOTCERT";
    var FORBIDDEN_CONTAINMENT_DATABASE_URL_ENV = "CONTAINMENT_APPLY_DATABASE_URL";
    var FORBIDDEN_FRLS_DATABASE_URL_ENV = "FREE_REVIEW_LEAD_SESSION_APPLY_DATABASE_URL";
    var APPLY_AUTHORIZATION_TOKEN2 = "I_AUTHORIZE_RA_PRO_BILLING_COMPANY_CUTOVER_APPLY_20260915004500";
    var ATTESTED_FREEZE_ENV = "RA_PRO_CUTOVER_ATTESTED_FREEZE";
    var GIT_CWD_ENV = "RA_PRO_CUTOVER_GIT_CWD";
    var EXPECTED_AUTH_SEALS_DIGEST = "c3bc387a0d4698b2a7e5c07fd5c18672a8dd4699efcd9f54f47c882173d2eabc";
    var EXPECTED_STANDALONE_BUNDLE_SHA256 = "PENDING_BUNDLE_BUILD_SHA256_PLACEHOLDER_00000000000000000000000000000000";
    var AUTHORIZED_TOOLING_FREEZE = "PLACEHOLDER_40HEX_0000000000000000000000000000000000000000";
    var STANDALONE_BUNDLE_PATH = "scripts/security/bundles/ra-pro-cutover-applicator.standalone.cjs";
    var EVIDENCE_PROTOCOL_ID = "RA_PRO_CUTOVER_EVIDENCE_V1";
    var CONTRACT_PATH = "docs/security/ra-pro-cutover-apply/PRE_CHANGE_CONTRACT.json";
    var FIXTURE_PATH = "docs/security/ra-pro-cutover-apply/LOCAL_FIXTURE_SCHEMA.sql";
    var TOOLING_AUTHORIZATION_PATH = "docs/security/ra-pro-cutover-apply/TOOLING_AUTHORIZATION.json";
    var DECISION_DOC_PATH = DECISION_PATH;
    var GATE_AWARE_MERGE_BASE_REF = "19e8bd071bae5f8afed85340f50168d4ca8e5586";
    ...
    module2.exports = {
      ...
      EXPECTED_PROJECT_REF: EXPECTED_PROJECT_REF2,
      ARTIFACT_COMMIT: ARTIFACT_COMMIT2,
      MIGRATION_PATH: MIGRATION_PATH2,
      MIGRATION_BLOB_OID: MIGRATION_BLOB_OID2,
      MIGRATION_SHA256: MIGRATION_SHA2562,
      MIGRATION_BYTES: MIGRATION_BYTES2,
      MIGRATION_VERSION: MIGRATION_VERSION2,
...
// scripts/security/ra-pro-cutover-evidence.js
var require_ra_pro_cutover_evidence = __commonJS({
  "scripts/security/ra-pro-cutover-evidence.js"(exports2, module2) {
    "use strict";
    var {
      SCHEMA_VERSION,
      MAX_PAYLOAD_BYTES,
    ...
    var PROTOCOL_ID = "RA_PRO_CUTOVER_EVIDENCE_V1";
    var PROTOCOL_PREFIX = `${PROTOCOL_ID}:`;
    var RESULT_CODES = Object.freeze([
    ...
    function normalizeApplicatorEvidence(partial) {
      ...
      const out = {
        ...
        sqlApplicationAttempts: typeof partial.sqlApplicationAttempts === "number" ? partial.sqlApplicationAttempts : 0,
        advisory_lock_acquired: Boolean(partial.advisory_lock_acquired),
        cleanup: partial.cleanup && typeof partial.cleanup === "object" ? partial.cleanup : { completed: true },
        credential_redaction_confirmation: partial.credential_redaction_confirmation && typeof partial.credential_redaction_confirmation === "object" ? partial.credential_redaction_confirmation : {
          url_in_evidence: false,
          url_in_argv: false,
          values_undisclosed: true
        }
      };
      const deny = /* @__PURE__ */ new Set(["database_url", "connectionString", "password", "url"]);
      for (const [k, v] of Object.entries(partial)) {
        if (out[k] !== void 0) continue;
        if (deny.has(k)) continue;
        if (v === void 0) continue;
...
var require_credential_browser_containment_constants = __commonJS({
  "scripts/security/credential-browser-containment-constants.js"(exports2, module2) {
    "use strict";
    var ADVISORY_LOCK2 = Object.freeze({
    ...
    var EXPECTED_PROJECT_REF2 = "jzmdgwwiestcmmeuhhkr";
    var ARTIFACT_COMMIT2 = "dadd4345c6b4f5df718f1e31f27b161d05fe7aa9";
    var MIGRATION_PATH2 = "supabase/migrations/20260908031736_connection_credential_browser_containment.sql";
    var MIGRATION_BLOB_OID2 = "a5051f23da5bc889d0612f76a61eec1c3cd487e7";
    var MIGRATION_SHA2562 = "71500fc8c56f484e3f2d5b49ff2b3161aad474027291a4eda22f26e7fc8071e7";
    var MIGRATION_BYTES2 = 10586;
    var MIGRATION_VERSION2 = "20260908031736";
    ...
    var EXPECTED_AUTH_SEALS_DIGEST = "3050fb80a8abab8e6a688ede125300042675cfb7965921ce9adf2e5b07729615";
    var EXPECTED_STANDALONE_BUNDLE_SHA256 = "PENDING_BUNDLE_BUILD_SHA256_PLACEHOLDER_00000000000000000000000000000000";
    var AUTHORIZED_TOOLING_FREEZE = "PENDING_AFTER_COMMIT";
    var STANDALONE_BUNDLE_PATH = "scripts/security/bundles/credential-browser-containment-applicator.standalone.cjs";
    var ROLLBACK_PATH = "docs/security/connection-credential-browser-containment/ROLLBACK_SECURITY_REGRESSION_BREAK_GLASS_ONLY.sql";
...
// scripts/security/ra-pro-cutover-tls-ca.js
var require_ra_pro_cutover_tls_ca = __commonJS({
  "scripts/security/ra-pro-cutover-tls-ca.js"(exports2, module2) {
    "use strict";
    var {
      FORBIDDEN_SSL_ROOTCERT_ENV,
      FORBIDDEN_CONTAINMENT_DATABASE_URL_ENV
    } = require_ra_pro_cutover_apply_constants();
    var containmentTls = require_containment_tls_ca();
    function tlsPolicyError(code, message) {
      const e = new Error(message);
      e.code = code;
      e.phase = "tls_policy";
    ...
    function buildPgClientOptions(databaseUrl, env = process.env, opts = {}) {
      ...
      if (Object.prototype.hasOwnProperty.call(env, FORBIDDEN_CONTAINMENT_DATABASE_URL_ENV) && env[FORBIDDEN_CONTAINMENT_DATABASE_URL_ENV]) {
        throw tlsPolicyError(
...
// scripts/security/ra-pro-cutover-apply-core.js
var require_ra_pro_cutover_apply_core = __commonJS({
  "scripts/security/ra-pro-cutover-apply-core.js"(exports2, module2) {
    "use strict";
    var crypto = require("crypto");
    ...
    var {
      classifyDatabaseUrl,
      normalizeApplicatorEvidence
    } = require_ra_pro_cutover_evidence();
    var {
      buildPgClientOptions,
      classifyTlsError
    } = require_ra_pro_cutover_tls_ca();
    ...
    function sanitizeValue2(value, depth = 0, seen = /* @__PURE__ */ new WeakSet()) {
      ...
      if (typeof value === "object") {
        ...
        if (value instanceof Error) {
          return {
            ...
            cause: value.cause ? sanitizeValue2(value.cause, depth + 1, seen) : void 0
          };
        }
        if (Array.isArray(value)) {
          return value.map((v) => sanitizeValue2(v, depth + 1, seen));
        }
        const out = {};
        for (const [k, v] of Object.entries(value)) {
          const key = String(k).toLowerCase();
          if (key.includes("password") || key.includes("connectionstring") || key.includes("database_url") || key.includes("databaseurl") || key.includes("sslrootcert") || key.includes("token_hash") || key === "lead_id" || key.includes("lead_id") || key === "firm_id" || key.includes("firm_id") || key === "company_id" || key.includes("company_id") || key.includes("billing_company_id") || key.includes("stripe") || key.includes("payment_intent") || key === "ca" || key === "argv" || key === "config" || key === "connectionparameters" || key === "access_token" || key === "refresh_token") {
            out[k] = "[redacted]";
            continue;
          }
          out[k] = sanitizeValue2(v, depth + 1, seen);
        }
        return out;
      }
      return redactString(value);
    }
    function sanitizeError2(err) {
      const sanitized = sanitizeValue2(err);
    ...
    function resolveDatabaseUrlFromEnv(env = process.env, expectedProjectRef = EXPECTED_PROJECT_REF2) {
      ...
      if (Object.prototype.hasOwnProperty.call(env, FORBIDDEN_FRLS_DATABASE_URL_ENV) && env[FORBIDDEN_FRLS_DATABASE_URL_ENV]) {
        const e = new Error(
    ...
    function assertFreezeDefenseInDepth(inputs) {
      ...
      if (EXPECTED_AUTH_SEALS_DIGEST && !EXPECTED_AUTH_SEALS_DIGEST.startsWith("PENDING_") && inputs.authSealsDigest !== EXPECTED_AUTH_SEALS_DIGEST) {
    ...
    function assertModeContract(inputs) {
      ...
      if (mode === "apply") {
        if (token !== APPLY_AUTHORIZATION_TOKEN2) {
          const e = new Error(
    ...
    function assertInputPins(inputs) {
      ...
      for (const k of required) {
        if (inputs[k] === void 0 || inputs[k] === null || inputs[k] === "") {
          const e = new Error(`MISSING_INPUT: ${k}`);
          e.code = "MISSING_INPUT";
          throw e;
        }
      }
      if (inputs.projectRef !== EXPECTED_PROJECT_REF2) {
        const e = new Error(
          `BLOCKED_PIN_MISMATCH: project ref got ${inputs.projectRef}, expected ${EXPECTED_PROJECT_REF2}`
        );
        e.code = "BLOCKED_PIN_MISMATCH";
        throw e;
      }
      assertFreezeDefenseInDepth(inputs);
      if (inputs.artifactCommit !== ARTIFACT_COMMIT2) {
        const e = new Error(
          `BLOCKED_PIN_MISMATCH: artifactCommit got ${inputs.artifactCommit}, expected ${ARTIFACT_COMMIT2}`
        );
        e.code = "BLOCKED_PIN_MISMATCH";
        throw e;
      }
      if (inputs.migrationPath !== MIGRATION_PATH2) {
        const e = new Error("BLOCKED_PIN_MISMATCH: migrationPath mismatch");
        e.code = "BLOCKED_PIN_MISMATCH";
        throw e;
      }
      if (inputs.migrationBlobOid !== MIGRATION_BLOB_OID2) {
        const e = new Error("BLOCKED_PIN_MISMATCH: migration blob OID mismatch");
        e.code = "BLOCKED_PIN_MISMATCH";
        throw e;
      }
      if (inputs.migrationSha256 !== MIGRATION_SHA2562) {
        const e = new Error("BLOCKED_PIN_MISMATCH: migration SHA-256 mismatch");
        e.code = "BLOCKED_PIN_MISMATCH";
        throw e;
      }
      if (Number(inputs.migrationBytes) !== MIGRATION_BYTES2) {
        const e = new Error("BLOCKED_PIN_MISMATCH: migration bytes mismatch");
        e.code = "BLOCKED_PIN_MISMATCH";
        throw e;
      }
      if (inputs.version !== MIGRATION_VERSION2) {
        const e = new Error(
          `BLOCKED_PIN_MISMATCH: version got ${inputs.version}, expected ${MIGRATION_VERSION2}`
        );
        e.code = "BLOCKED_PIN_MISMATCH";
        throw e;
      }
      if (inputs.name !== MIGRATION_NAME2) {
        const e = new Error(
          `BLOCKED_PIN_MISMATCH: name got ${inputs.name}, expected ${MIGRATION_NAME2}`
        );
        e.code = "BLOCKED_PIN_MISMATCH";
        throw e;
      }
  ...
  `);
    ...
    function assertPreChangeMatch(probe) {
      if (!probe.firms_table_exists || !probe.companies_table_exists || probe.billing_company_id_column_exists || probe.bootstrap_firm_fn_exists || probe.bootstrap_company_fn_exists || probe.activate_ra_pro_fn_exists || probe.capacity_lock_fn_exists || probe.protect_fn_exists) {
        throw new Error(
  ...
  `);
      const r = rows[0];
      if (!r.billing_company_id_column_exists || !r.bootstrap_firm_fn_exists || !r.bootstrap_company_fn_exists || !r.activate_ra_pro_fn_exists || !r.capacity_lock_fn_exists || !r.svc_bootstrap_firm_exec || !r.svc_bootstrap_company_exec || !r.svc_activate_exec || r.anon_bootstrap_firm_exec || r.auth_bootstrap_firm_exec || r.anon_bootstrap_company_exec || r.auth_bootstrap_company_exec || r.anon_activate_exec || r.auth_activate_exec || Number(r.linked_firms_count) !== EXPECTED_LINKED_FIRMS_AFTER_MIGRATION) {
  ...
  `);
      ...
      probes.linked_firms_zero = Number(linked[0] && linked[0].c) === EXPECTED_LINKED_FIRMS_AFTER_MIGRATION;
  ...
  `);
      ...
      if (!probes.billing_company_id_column || !probes.linked_firms_zero || !probes.bootstrap_firm_service_only || !probes.bootstrap_company_service_only || !probes.activate_ra_pro_service_only || !probes.capacity_lock_present) {
    ...
    function loadSealedDecision(inputs) {
      ...
      if (Number(actions.NO_CUTOVER) !== EXPECTED_DECISION_ACTIONS.NO_CUTOVER || Number(actions.LINK_EXISTING_FIRM) !== EXPECTED_DECISION_ACTIONS.LINK_EXISTING_FIRM || Number(actions.CREATE_NEW_FIRM) !== EXPECTED_DECISION_ACTIONS.CREATE_NEW_FIRM) {
        const e = new Error(
      ...
      if (Number(decision.expected_linked_firms_after_migration) !== EXPECTED_LINKED_FIRMS_AFTER_MIGRATION) {
    ...
    function assertPriorDryRunPinsPublished(inputs) {
      ...
      const unpublished = !pub || pub.status === "UNPUBLISHED" || pub.status == null || pins.some(
        (p) => p == null || p === "" || String(p) === "null" || String(p).startsWith("PLACEHOLDER_")
      );
      if (unpublished) {
        const e = new Error(
    ...
    function isConnectionUncertaintyError(err) {
      ...
      return err instanceof IndeterminateCommitError || code === "INDETERMINATE_OUTCOME" || code === "ECONNRESET" || code === "EPIPE" || code === "ETIMEDOUT" || code === "57P01" || code === "57P02" || code === "57P03" || /connection (terminated|closed|ended|refused|reset)|timeout|sock|not queryable|server closed/i.test(
        msg
      );
    }
    ...
    async function reconcileAfterIndeterminate(databaseUrl, inputs, packed, priorManifest, env = process.env) {
      ...
      try {
        await withClient(databaseUrl, async (client) => {
          ...
          if (rows.length === 0) {
            ...
            result.classification = result.pre_change_restored && result.prior_manifest_unchanged !== false ? "NOT_APPLIED_CONFIRMED" : "INDETERMINATE_REQUIRES_OPERATOR";
            return;
          }
          result.version_present = true;
          const stmts = rows[0].statements || [];
          result.statement_count = stmts.length;
          result.statement_match = stmts.length === 1 && stmts[0] === packed.fullSql && sha256Buffer(Buffer.from(stmts[0], "utf8")) === packed.loaded.sha256;
          try {
          ...
          if (result.statement_match && result.post_apply_ok && result.prior_manifest_unchanged !== false) {
      ...
      result.operator_note = "No automatic retry or rollback. New authorization required before any further mutation.";
      return result;
    }
        ...
        await withClient(
          ...
          async (client) => {
            ...
            evidence.decision_authority = {
              ...
              expected_linked_firms_after_migration: packed.decision.decision.expected_linked_firms_after_migration
            };
            evidence.version_absent = true;
            evidence.migration_objects_absent = !probe.billing_company_id_column_exists && !probe.bootstrap_firm_fn_exists && !probe.bootstrap_company_fn_exists && !probe.activate_ra_pro_fn_exists && !probe.capacity_lock_fn_exists && !probe.protect_fn_exists;
        ...
        try {
          await withClient(databaseUrl, async (client) => {
            ...
            try {
              ...
              evidence.rollback_verify.pre_change_error = sanitizeError2(probeErr);
            }
            if (priorManifest) {
              const now = await captureHistoryManifest(client);
...
var {
  ...
  sanitizeError,
  sanitizeValue
} = require_ra_pro_cutover_apply_core();
var {
...
function printHelp() {
  const help = {
    mechanism: "GIT_BLOB_PINNED_SINGLE_VERSION_TX_APPLY",
    evidence_protocol: "RA_PRO_CUTOVER_EVIDENCE_V1",
...
async function main() {
  ...
  if (evidence.verdict === "DRY_RUN_READY_FOR_SEPARATE_APPLY_AUTHORIZATION" || evidence.result_code === "DRY_RUN_READY_FOR_SEPARATE_APPLY_AUTHORIZATION" || evidence.verdict === "APPLY_COMMITTED" || evidence.verdict === "INDETERMINATE_OUTCOME") {
