...
var require_free_review_lead_session_apply_constants = __commonJS({
  "scripts/security/free-review-lead-session-apply-constants.js"(exports2, module2) {
    "use strict";
    ...
    var ARTIFACT_COMMIT2 = "b2c431fa4310f58c9ee667e858333e084c2fed52";
    var MIGRATION_PATH2 = "supabase/migrations/20260913235500_free_review_lead_sessions.sql";
    var MIGRATION_BLOB_OID2 = "7dca9674673eb51ab5094d3ec09508d0711f16cd";
    var MIGRATION_SHA2562 = "b7e1e68b82a5975e85e1b9d6f0c491fa632474801ce00b311cea366f3b9b0ddb";
    var MIGRATION_BYTES2 = 8108;
    var MIGRATION_VERSION2 = "20260913235500";
    var MIGRATION_NAME2 = "free_review_lead_sessions";
    var PRIOR_HISTORY_COUNT = 186;
    var DATABASE_URL_ENV2 = "FREE_REVIEW_LEAD_SESSION_APPLY_DATABASE_URL";
    var FORBIDDEN_SSL_ROOTCERT_ENV = "FREE_REVIEW_LEAD_SESSION_APPLY_SSL_ROOTCERT";
    var FORBIDDEN_CONTAINMENT_DATABASE_URL_ENV = "CONTAINMENT_APPLY_DATABASE_URL";
    var APPLY_AUTHORIZATION_TOKEN2 = "I_AUTHORIZE_FREE_REVIEW_LEAD_SESSIONS_APPLY_20260913235500";
    var ATTESTED_FREEZE_ENV = "FRLS_ATTESTED_FREEZE";
    var GIT_CWD_ENV = "FRLS_GIT_CWD";
    var EXPECTED_AUTH_SEALS_DIGEST = "f91ef6bb252de388b1cd179b189a6e4657c3338cf955f5effad243da4dafe40e";
    var EXPECTED_STANDALONE_BUNDLE_SHA256 = "PENDING_BUNDLE_BUILD_SHA256_PLACEHOLDER_00000000000000000000000000000000";
    var AUTHORIZED_TOOLING_FREEZE = "fdd365018a091d9f828df11af1c0afb66a7dcba5";
    ...
    var FIXTURE_PATH = "docs/security/free-review-lead-session-apply/LOCAL_FIXTURE_SCHEMA.sql";
    var TOOLING_AUTHORIZATION_PATH = "docs/security/free-review-lead-session-apply/TOOLING_AUTHORIZATION.json";
...
// scripts/security/free-review-lead-session-evidence.js
var require_free_review_lead_session_evidence = __commonJS({
  "scripts/security/free-review-lead-session-evidence.js"(exports2, module2) {
    "use strict";
    var {
      SCHEMA_VERSION,
      MAX_PAYLOAD_BYTES,
    ...
    var PROTOCOL_ID = "FRLS_LEAD_SESSION_EVIDENCE_V1";
    var PROTOCOL_PREFIX = `${PROTOCOL_ID}:`;
    var RESULT_CODES = Object.freeze([
...
// scripts/security/free-review-lead-session-tls-ca.js
var require_free_review_lead_session_tls_ca = __commonJS({
  "scripts/security/free-review-lead-session-tls-ca.js"(exports2, module2) {
    "use strict";
    var {
      FORBIDDEN_SSL_ROOTCERT_ENV,
      FORBIDDEN_CONTAINMENT_DATABASE_URL_ENV
    } = require_free_review_lead_session_apply_constants();
...
// scripts/security/free-review-lead-session-apply-core.js
var require_free_review_lead_session_apply_core = __commonJS({
  "scripts/security/free-review-lead-session-apply-core.js"(exports2, module2) {
    "use strict";
    var crypto = require("crypto");
    ...
    var {
      classifyDatabaseUrl,
      normalizeApplicatorEvidence
    } = require_free_review_lead_session_evidence();
    var {
      buildPgClientOptions,
      classifyTlsError
    } = require_free_review_lead_session_tls_ca();
    ...
    function sanitizeValue2(value, depth = 0, seen = /* @__PURE__ */ new WeakSet()) {
      ...
      if (typeof value === "object") {
        ...
        for (const [k, v] of Object.entries(value)) {
          ...
          if (key.includes("password") || key.includes("connectionstring") || key.includes("database_url") || key.includes("databaseurl") || key.includes("sslrootcert") || key.includes("token_hash") || key === "lead_id" || key.includes("lead_id") || key === "ca" || key === "argv" || key === "config" || key === "connectionparameters" || key === "access_token" || key === "refresh_token") {
            out[k] = "[redacted]";
            continue;
          }
    ...
    function assertFreezeDefenseInDepth(inputs) {
      ...
      if (AUTHORIZED_TOOLING_FREEZE && AUTHORIZED_TOOLING_FREEZE !== "PENDING_AFTER_COMMIT" && inputs.authorizedPrHead !== AUTHORIZED_TOOLING_FREEZE) {
  ...
  `);
    ...
    function assertPreChangeMatch(probe) {
      if (!probe.parent_table_exists || !probe.parent_status_column || probe.sessions_table_exists || probe.rotate_fn_exists || probe.cleanup_fn_exists || probe.delete_guard_fn_exists || probe.token_hash_index_exists || probe.one_unrevoked_index_exists || probe.delete_guard_trigger_exists) {
        throw new Error(
  ...
  `);
      const r = rows[0];
      if (!r.table_exists || !r.rls_enabled || !r.svc_sel || !r.svc_ins || !r.svc_upd || !r.svc_del || r.anon_sel || r.auth_sel || r.anon_ins || r.auth_ins || !r.rotate_fn_exists || !r.cleanup_fn_exists || !r.svc_rotate_exec || !r.svc_cleanup_exec || r.anon_rotate_exec || r.auth_rotate_exec || r.anon_cleanup_exec || !r.one_unrevoked_index_exists || !r.delete_guard_trigger_exists) {
...
var {
  ...
  sanitizeError,
  sanitizeValue
} = require_free_review_lead_session_apply_core();
var {
