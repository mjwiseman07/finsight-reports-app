...
.DESCRIPTION
  Invoked only after tip→freeze seal verification by enter-visible-ra-pro-cutover-ceremony.ps1.
  ...
  Never reads RA_PRO_CUTOVER_APPLY_DATABASE_URL. Never uses cmd.exe or PATH powershell.exe.
#>
[CmdletBinding()]
param(
