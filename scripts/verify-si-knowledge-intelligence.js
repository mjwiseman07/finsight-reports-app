...
const modules = [
  ...
  {
    phase: "37N",
    module: "enterprise-knowledge-package",
    singularName: "EnterpriseKnowledgePackage",
    pluralName: "EnterpriseKnowledgePackages",
    artifact: "SyntheticEnterpriseKnowledgePackage",
    idToken: "enterpriseKnowledgePackageId",
    keyToken: "enterpriseKnowledgePackageKey",
    nullToken: "enterpriseKnowledgePackage: null",
    resultToken: "enterpriseKnowledgePackage",
    collectionResultToken: "enterpriseKnowledgePackages",
    extraMarkers: [
