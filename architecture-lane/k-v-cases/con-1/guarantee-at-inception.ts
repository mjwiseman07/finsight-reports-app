 ...
 */
import { evaluateGuaranteeAtInception } from "../../../lib/intelligence/synthetic/libraries/construction/asc460/guarantees";
import { extractEscalationAudits } from "../_helpers/kv-case-helpers";

export function runCases() {
  try {
    evaluateGuaranteeAtInception(null);
    return [{ id: "KV-GUA-1", pass: false, reason: "silent rejection" }];
  } catch (err) {
