...
import { fetchSandboxChecklistForCockpit } from "@/lib/journal-entry-governance/sandbox-je-cockpit-api";
import {
...
export async function GET(request: Request, context: RouteContext) {
  ...
  try {
    const payload = await fetchSandboxChecklistForCockpit(executionId);
