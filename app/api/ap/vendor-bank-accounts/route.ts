...
import { registerVendorBankAccount } from "@/lib/ap-intake/payments/service";
...
export async function POST(req: Request) {
  try {
    ...
    const out = await registerVendorBankAccount({
      firmId,
      ...
      registeredByUserId: String(body.registered_by_user_id ?? auth.userId),
    });
